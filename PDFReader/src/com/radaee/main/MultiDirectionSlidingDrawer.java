...
public class MultiDirectionSlidingDrawer extends ViewGroup {
	...
	protected void onLayout( boolean changed, int l, int t, int r, int b )
	{
		...
		//left:220,top:0,width:70,height:70
	//	Log.e("SlidingDrawew","handleLeft"+handleLeft+"handleTop"+handleTop+"handleWidth"+handleWidth+"handleHeight"+handleHeight);
	//	handle.layout( handleLeft, handleTop, handleLeft + handleWidth, handleTop + handleHeight );
		handle.layout( 70, handleTop, 70 + handleWidth, handleTop + handleHeight );
