...
public class Global {
	 ...
	 */
	public static int inkColor = 0x80C0C0C0;
	/**
	 * width for ink lines.
	 */
	...
	public static void Init(Activity act)
	{
		...
		if (!setTextFont("DroidSansFallback") && face_name != null) {
			setTextFont(face_name);
		}
	...
	public static void default_config() {
		...
		def_view = 0;// 0,1,2,3,4,5,6 0:vertical 1:horizon 2:scroll 3:single
